...
void joystick_init(void) {
 ...
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1<<28); //P1.26 Input (joysticks on PORT1 defined as Input)
  ...
  ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL3 &= ~(3<<26); //PIN mode GPIO (00b value per P1.26)
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00020) )->FIODIR &= ~(1<<29); //P1.26 Input (joysticks on PORT1 defined as Input)
