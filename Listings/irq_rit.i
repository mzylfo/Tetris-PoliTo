...
# 1 "Source/RIT\\../tetris/tetris.h" 1
  ...
  // Down
    ...
    if(down_1 != 0){
       ...
       key1_event = 1;
            ...
            down_1 = 0;
            ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 = (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 & ~(3 << 22)) | (1 << 22); // Reset a EINT1
            ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 1); // Pulisce flag
            __NVIC_ClearPendingIRQ(EINT1_IRQn);
    ...
    if(down_2 != 0){
       ...
       key2_event = 1;
            ...
            down_2 = 0;
            ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 = (((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 & ~(3 << 24)) | (1 << 24); // Reset a EINT2
            ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->EXTINT |= (1 << 2);
            __NVIC_ClearPendingIRQ(EINT2_IRQn);
