...
# 1 "Source/timer\\../tetris/tetris.h" 1
...
void TIMER0_IRQHandler (void)
{
 ...
 if (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->IR & 01)
 {
  gravity_event = 1;
...
# 49 "Source/timer/IRQ_timer.c"
void TIMER2_IRQHandler (void)
{
# 159 "Source/timer/IRQ_timer.c"
 ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->IR = 0xFF; //RESETTING TIMER

  return;
}
# 173 "Source/timer/IRQ_timer.c"
void TIMER3_IRQHandler (void)
{

 if (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR & 01)
 {
 ...
 if(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR & 02)
  {
 ...
 if(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR & 4)
  {
 ...
 if(((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->IR & 8)
  {
